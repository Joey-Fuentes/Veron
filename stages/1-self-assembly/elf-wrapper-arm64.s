// ============================================================================
// Veron — Stage 1 Self-Assembly: elf-wrapper  (ARM64 / AArch64)            *** OFFICIAL — invariants ON ***
// ============================================================================
//
...
//
//       program.s | self-assembler | elf-wrapper OUTPATH        (produces a runnable file)
//
...
// ============================================================================
    ...
    // mapping ends exactly at the last byte of code, so a seed-built self-assembler
    // could not hold its own symbol table, let alone a 64 MiB input reserve.
    //
    // 68 MiB covers self-assembler's needs (35 KB symtab + 64 MiB input) with room
...
header:
    ...
    .balign 8
cbover:  .ascii  "elf-wrapper: code exceeds CODEBUF_SZ\n"
...
// self-assembler's bss_origin; see the self-assembler source.
bss_origin: .space 16
    .align  4
